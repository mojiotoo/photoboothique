...
═══════════════════════════════════════════════════════════ */
const FRAME_CONFIGS = {
    'classic-baby-pink': { cssClass: 'frame-classic-baby-pink', layout: 'strip-4',  frameW: 280, frameH: 500, footerH: 50, gap: 4, pad: 6 },
    'everyday-white':    { cssClass: 'frame-everyday-white',    layout: 'strip-4',  frameW: 280, frameH: 500, footerH: 50, gap: 4, pad: 6 },
    'shimmer-pink':      { cssClass: 'frame-shimmer-pink',      layout: 'instax',   frameW: 280, frameH: 380, footerH: 50, gap: 0, pad: 10 },
    'og-black':          { cssClass: 'frame-og-black',          layout: 'grid-2x2', frameW: 360, frameH: 400, footerH: 48, gap: 5, pad: 8 },
};
...
function buildFrame() {
    ...
    frameOuter.className = `frame-outer ${cfg.cssClass}`;
    ...
    else                                { slotCount = 1; cols = 1; rows = 1; }  // instax
    ...
    // Deselect sticker when clicking frame background
